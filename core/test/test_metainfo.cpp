...
TEST(Metainfo, Parsing) {
  ...
  {
    auto animal_farm = Metainfo::from_file(tests / animal_farm_fname);
    EXPECT_EQ(
        animal_farm.info_hash(),
        SHA1::from_hex_string("246551a33080b1c4827d09466f22380d78a667c8"));
    ...
    std::vector<std::tuple<const char *, std::size_t, std::size_t>> expected{
        {"AnimalFarmByGeorgeOrwell/Animal Farm by George Orwell.epub", 127971,
         0},
        {"AnimalFarmByGeorgeOrwell/Animal Farm by George Orwell.mobi", 164079,
         127971},
        {"AnimalFarmByGeorgeOrwell/Animal Farm by George Orwell.pdf", 474025,
         292050},
        {"AnimalFarmByGeorgeOrwell/Animal Farm by George Orwell_abbyy.gz",
         2266942, 766075},
        {"AnimalFarmByGeorgeOrwell/Animal Farm by George Orwell_daisy.zip",
         111373, 3033017},
        {"AnimalFarmByGeorgeOrwell/Animal Farm by George Orwell_djvu.txt",
         175665, 3144390},
        {"AnimalFarmByGeorgeOrwell/Animal Farm by George Orwell_djvu.xml",
         1691837, 3320055},
        {"AnimalFarmByGeorgeOrwell/Animal Farm by George Orwell_jp2.zip",
         57746785, 5011892},
        {"AnimalFarmByGeorgeOrwell/Animal Farm by George Orwell_scandata.xml",
         32527, 62758677},
        {"AnimalFarmByGeorgeOrwell/AnimalFarmByGeorgeOrwell_meta.sqlite", 23552,
         62791204},
        {"AnimalFarmByGeorgeOrwell/AnimalFarmByGeorgeOrwell_meta.xml", 2010,
         62814756},
